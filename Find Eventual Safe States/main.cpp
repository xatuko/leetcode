...
vector<int> eventualSafeNodes(vector<vector<int>>& graph)
{
    ...
    {
        if (term_node.find(i) != term_node.end())
        {
            i++;
            continue;
        }
        ...
        for (; j < graph[i].size(); j++)
            if (term_node.find(graph[i][j]) == term_node.end())
                break;
